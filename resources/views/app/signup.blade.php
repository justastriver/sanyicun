...
<head lang="en">
  <meta charset="UTF-8">
  <title>Signup Page | Amaze UI Example</title>
...
<div class="coo-weixin-mod">
    <div class="weixin-inner">
        ...
        <div class="qrcode-weixin">
            <img src="assets/images/manager-qrcode.jpg" alt="">
        </div>
