...
<div class="properties-mod module-wrap">
  <div class="am-container">
    <ul class="properties-list am-avg-sm-2 am-avg-md-4">
      <li >
        <img src="/images/properties-img1.jpg" />
        <p>只需插入一行代码</p>
      </li>
      <li >
        <img src="/images/properties-img2.jpg" />
        <p>网址不变</p>
      </li>
      <li>
        <img src="/images/properties-img3.jpg" />
        <p>内容同步更新</p>
      </li>
      <li>
        <img src="/images/properties-img4.jpg" />
        <p>云端加速</p>
      </li>      
    </ul>
  </div>
