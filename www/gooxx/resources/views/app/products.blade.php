    ...
    <div class="am-tabs-bd">
      <div data-tab-panel-0 class="am-tab-panel am-active">
        <div class="products-item-wrap">
          <div class="am-container products-item">
            ...
            <img src="assets/images/products/manage_src_1.png" />
          </div>
        </div>
        <div class="products-item-wrap">
          <div class="am-container products-item">
        ...
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <div class="am-u-md-5 sm-u-sm-12 products-pic">
              <img src="assets/images/products/product-1-2.png" alt=""/>
            </div>
            <div class="am-u-md-6 am-u-sm-12 products-text">
              <h5>可视化操作</h5>
        ...
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <div class="am-u-md-5 sm-u-sm-12 products-pic">
              <img src="assets/images/products/product-1-3.png" alt=""/>
            </div>
            <div class="am-u-md-6 am-u-sm-12 products-text">
              <h5>多层级</h5>
        ...
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <div class="am-u-md-5 sm-u-sm-12 products-pic">
              <img src="assets/images/products/product-1-4.png" alt=""/>
            </div>
            <div class="am-u-md-6 am-u-sm-12 products-text">
              <h5>多设备同步编辑预览</h5>
      ...
      <div data-tab-panel-1 class="am-tab-panel ">
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <h2>清晰、完善的服务管理后台</h2>
            <img src="assets/images/products/manage_src_2.png" />
          </div>
        </div>
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <div class="am-u-md-5 sm-u-sm-12 products-pic">
              <img src="assets/images/products/product-2-1.png" alt=""/>
            </div>
            <div class="am-u-md-6 am-u-sm-12 products-text">
              <h5>统计服务</h5>
        ...
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <div class="am-u-md-5 sm-u-sm-12 products-pic">
              <img src="assets/images/products/product-2-2.png" alt=""/>
            </div>
            <div class="am-u-md-6 am-u-sm-12 products-text">
              <h5>优先获取百度轻直达号</h5>
        ...
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <div class="am-u-md-5 sm-u-sm-12 products-pic">
              <img src="assets/images/products/product-2-3.png" alt=""/>
            </div>
            <div class="am-u-md-6 am-u-sm-12 products-text">
              <h5>云加速</h5>
        ...
        <div class="products-item-wrap">
          <div class="am-container products-item">
            <div class="am-u-md-5 sm-u-sm-12 products-pic">
              <img src="assets/images/products/product-2-4.png" alt=""/>
            </div>
            <div class="am-u-md-6 am-u-sm-12 products-text">
              h5>快速拥有原生APP</h5>
      ...
      <div data-tab-panel-2 class="am-tab-panel ">
        <div class="products-item-wrap">
          <div class="am-container products-item">
            ...
            <img src="assets/images/products/manage_src_3.png" />
          </div>
        </div>
        <div class="products-item-wrap">
          <div class="am-container products-item">
