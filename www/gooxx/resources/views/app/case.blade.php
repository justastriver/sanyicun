...
<head lang="en">
  <meta charset="UTF-8">
  <title>Products Page | Amaze UI Example</title>
    ...
    <div data-am-widget="slider" class="am-slider am-slider-default" data-am-slider='{&quot;controlNav&quot;:false}'>
      <ul class="am-slides">
        <li>
          <div class="case-item-mod">
              <div class="case-item-pic">
                  <img src="assets/images/case/case-sample1.png" alt=""/>
              </div>
              <div class="case-item-text">
                <h5 class="company-logo"><img src="assets/images/case/case-logo1.png" alt="Gov.cn" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="assets/images/case/case-sample2.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="assets/images/case/case-logo2.png" alt="微软亚太研发集团" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="assets/images/case/case-sample3.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="assets/images/case/case-logo3.png" alt="海信" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="assets/images/case/case-sample4.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="assets/images/case/case-logo4.png" alt="光明网" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="assets/images/case/case-sample5.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="assets/images/case/case-logo5.png" alt="罗莱家纺" /></h5>
        ...
        <li>
          <div class="case-item-mod">
            <div class="case-item-pic">
              <img src="assets/images/case/case-sample6.png" alt=""/>
            </div>
            <div class="case-item-text">
              <h5 class="company-logo"><img src="assets/images/case/case-logo6.png" alt="中国银泰" /></h5>
    ...
    <ul data-am-widget="gallery" class="am-gallery am-avg-sm-2 am-avg-md-3 am-avg-lg-3 am-gallery-default" data-am-gallery="{ pureview: true }">
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case1.png" alt="美国Bellevue市政府"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case2.png" alt="老板电器"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case3.png" alt="IT桔子"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case4.png" alt="中关村管委会"/>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case5.png" alt="易观智库"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case6.png" alt="纷享销客"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case7.png" alt="中国企业家"/>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case8.png" alt="CSDN"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case9.png" alt="51CTO技术博客"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case10.png" alt="快鲤鱼"/>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case11.png" alt="中青在线"/>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
          ...
          <img src="assets/images/case/case12.png" alt="创业邦"/>
        </div>
      </li>
    </ul>
